...
const Footer = () => {
   ...
   const News=[ "trending stories","featured videos","technology","health","politics","environment"]
   const Blogs=["quantum computing","AI ethics","space exploration","bio teachnology","renewable energy","biohacking"]
    ...
    <div className='capitalize text-white font-inter w-[100%] bg-[#141414] h-[fit] p-6 md:mx-auto lg:mx-0'>
        <footer className='grid  place-items-center xs:gap-4 sm:gap-0 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-5 border-b-1  border-[#1e1e1e] p-5 w-[100%] mb-2' >
          <div className='h-fit w-fit'>
             <h2 className='xs:text-sm md:text-md lg:text-lg font-semibold mb-4'>home</h2>
             {
               home.map((item,index)=>(
               <ul key={index}>
                <Link to={item.link} className='cursor-pointer xs:text-ss sm:text-xs lg:text-sm text-gray-500 '>
          ...
          <div className='w-fit'>
             <h2 className='xs:text-sm md:text-md lg:text-lg mb-4 font-semibold'>News</h2>
              {News.map((item,index)=>(
               <ul key={index}>
            ...
            <div className='w-fit'>
             <h2 className='xs:text-sm md:text-md lg:text-lg mb-4 font-semibold'>Blogs</h2>
           ...
           <div className='w-fit'>
             <h2 className='xs:text-sm md:text-md lg:text-lg mb-4 font-semibold'>podcasts</h2>
              ...
              <div className='sm:w-full md:w-fit  flex flex-col gap-3'>
             <h2 className='xs:text-sm md:text-md lg:text-lg xs:mt-4 md:mt-0 xs:mb-2 md:mb-4 font-semibold'>resources</h2>
       ...
       <aside className='flex w-full justify-around sm:items-center xs:flex-col sm:flex-row'> 
            <div className='flex justify-between sm:w-[55%] md:w-[50%] lg:w-[40%] sm:items-center xs:flex-col-reverse sm:flex-row'>
              <p className='text-gray-600  xs:py-2 sm:py-0 xs:text-xs lg:text-sm'>terms & conditions<span className='ml-2 border-l-1 border-gray-500 pl-2'>privacy policy</span></p>
               {/* for the icon */}
