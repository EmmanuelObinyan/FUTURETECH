     ...
     <Navbar/>
      <section className='xs:mt-26 sm:mt-32 lg:mt-37'>
         {/* revisit page to fix the appropriate picture and the text for the news page */}
           ...
           />
            <NewsPost/>
           <section className='grid xs:grid-cols-1 sm:grid-cols-3 place-items-center h-fit bg-[#141414] sm:p-2 md:p-4 lg:p-6 md:gap-3 lg:gap-0 w-full'>
               <NewsCard
                news_image={pic1}
            ...
            />
            <div className="p-2 h-fit font-inter  text-white bg-[#141414] w-[100%] ">
        ...
        <TabLayout blog={NewsArr} />
         ...
         <MainSectionComp
             ...
             handleNavigate={()=>navigate('/news')}
            /> 
           <div className="grid grid-cols-2 p-4 bg-[#141414] text-white font-inter">
              for the news video
              <VideoComp/>
            </div> 
            {/* for the footer part */}
